...
describe('dueDate validation', () => {
  ...
  it('should reject a past date', async () => {
    ...
    await expect(validateTask.create(data))
      .rejects.toThrow('Deadline moet in de toekomst liggen');
  });
  ...
  it('should reject invalid date formats', async () => {
    ...
    await expect(validateTask.create(data))
      .rejects.toThrow('Deadline moet een geldige datum zijn');
  });
...
describe('description field validation', () => {
  ...
  it('should enforce maximum length', async () => {
    ...
    await expect(validateTask.create(data))
      .rejects.toThrow('Beschrijving mag maximaal 1000 karakters zijn');
  });
...
describe('assigneeId validation', () => {
  ...
  it('should reject invalid UUID format', async () => {
    ...
    await expect(validateTask.create(data))
      .rejects.toThrow('Ongeldig gebruikers ID');
  });
